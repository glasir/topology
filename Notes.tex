...
% A nice placeholder image.  Well, it will be nicer eventually, when it is replace by real pictures.
\newcommand{\placeholder}{\[\includegraphics[width=100pt]{images/placeholder.pdf}\]}
...
\input{tex_files/continuity_etc} 
\input{tex_files/topologies} 
\input{tex_files/continuity_and_topology} 
\input{tex_files/subspaces_and_bases} 
\input{tex_files/quotient_spaces} 
\input{tex_files/product_topology} 
\input{tex_files/compactness} 
\input{tex_files/hausdorffness} 
\input{tex_files/normalness} 
\input{tex_files/connectedness} 
\input{tex_files/homotopy} 
\input{tex_files/fundamental_group} 
\input{tex_files/covering_spaces}
